package com.example.logdatafrommember.security.api;



import com.example.logdatafrommember.logging.service.HasLoggedInService;
import com.example.logdatafrommember.security.dto.LoginRequest;
import com.example.logdatafrommember.security.dto.LoginResponse;
...
public class AuthenticationController {
  ...
  private final HasLoggedInService hasLoggedInService;
  ...
  public ResponseEntity<LoginResponse> login(@RequestBody LoginRequest request) {
    try {
      ...
      hasLoggedInService.registerLogin(user);
